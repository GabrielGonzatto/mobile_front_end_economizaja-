...
class _TelaCadastroLancamentoState extends State<cadastroDespesa> {
  ...
  void initState() {
    super.initState();
    futureCategorias = CategoriaService.listarCategoriasDeDespesa();
  }
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    onPressed: () async {
                      if (await LancamentoService.cadastrarDespesa(lancamento)) {
                        if (_image != null) {
                          await _uploadImage();
                        }
